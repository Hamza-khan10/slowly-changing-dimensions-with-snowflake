...
-- Optional: set this parameter for your session
ALTER SESSION SET ERROR_ON_NONDETERMINISTIC_MERGE = FALSE;

USE ROLE ACCOUNTADMIN;

GRANT USAGE ON DATABASE SCD_DEMO TO ROLE SECURITYADMIN;
GRANT USAGE ON SCHEMA SCD_DEMO.SCD2 TO ROLE SECURITYADMIN;
GRANT CREATE TASK ON SCHEMA SCD_DEMO.SCD2 TO ROLE SECURITYADMIN;
...
CALL pdr_scd_demo();
show tasks;
alter task task_scd_raw suspend;--resume --suspend
show tasks;
